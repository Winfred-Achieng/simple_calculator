...
plus = Button(frame, text='+', height=2, width=6, font=30, command=lambda :button_press('+'))
plus.grid(row=0,column=3)

minus = Button(frame, text='-', height=2, width=6, font=30, command=lambda :button_press('-'))
minus.grid(row=1,column=3)

multiply = Button(frame, text='*', height=2, width=6, font=30, command=lambda :button_press('*'))
multiply.grid(row=2,column=3)

division = Button(frame, text='/', height=2, width=6, font=30, command=lambda :button_press('/'))
division.grid(row=3,column=3)

equal = Button(frame, text='=', height=2, width=6, font=30, command=equals)
equal.grid(row=3,column=2)

decimal = Button(frame, text='.', height=2, width=6, font=30, command=lambda :button_press('.'))
decimal.grid(row=3,column=1)

clear = Button(window, text='clear', height=2, width=10, font=30, command=clear)
clear.pack()
